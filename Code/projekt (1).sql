...
--
-- Host: localhost
-- Generation Time: Jun 05, 2019 at 06:03 AM
...
--
ALTER TABLE `invoice_orders`
  ADD CONSTRAINT `invoice_orders_ibfk_1` FOREIGN KEY (`order_to`) REFERENCES `customers` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
